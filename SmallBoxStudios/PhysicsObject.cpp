...
void PhysicsObject::Update(float dt)
{
	...
	XMMATRIX rotationI = XMMatrixRotationQuaternion(XMLoadFloat4(&XMFLOAT4(0.0f, 0.7071f, 0.0f, 0.7071f)));
...
void PhysicsObject::SetDynamicWorld(btDynamicsWorld* _dynamicsWorld)
{
