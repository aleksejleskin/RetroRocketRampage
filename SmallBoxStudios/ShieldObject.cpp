...
ShieldObject::ShieldObject(string filename, float mass) : PhysicsObject()
{
	m_filename = filename;
...
bool ShieldObject::LoadContent(DxGraphics *dx, XMFLOAT3 position, ResourceManager& resource,
...
void ShieldObject::Render(DxGraphics* dx, Camera& cam, LightManager& lightManager)
{
...
void ShieldObject::UnloadContent()
{
